...
internal class SendRequestTest {
    ...
    fun testSerialization(expected: SendResponse, socketResponseJson: String) {
        val testSocketCommunicator = object : SocketCommunicator {
            override fun submit(request: String): String {
                ...
                assert(version != null && version is JsonPrimitive && version.content == "v1") {
                    "bad request version v1: got $version (request: $requestObject)"
                }
                assert((requestObject["recipientAddress"] != null) xor (requestObject["recipientGroupId"] != null)) {
