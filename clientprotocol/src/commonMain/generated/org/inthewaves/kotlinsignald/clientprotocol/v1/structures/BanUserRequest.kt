...
import org.inthewaves.kotlinsignald.clientprotocol.v1.requests.BanUser
...
@Serializable
@SerialName("ban_user")
public data class BanUserRequest(
    /**
    ...
    internal override val responseWrapperSerializer: KSerializer<BanUser>
        get() = BanUser.serializer()

    internal override val responseDataSerializer: KSerializer<JsonGroupV2Info>
        get() = JsonGroupV2Info.serializer()

    internal override fun getTypedResponseOrNull(responseWrapper: JsonMessageWrapper<*>):
        JsonGroupV2Info? = if (responseWrapper is BanUser && responseWrapper.data is
        JsonGroupV2Info
    ) {
