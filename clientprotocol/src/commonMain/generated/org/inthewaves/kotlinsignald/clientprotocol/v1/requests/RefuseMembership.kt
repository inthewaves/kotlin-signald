 ...
 * an instance of [org.inthewaves.kotlinsignald.clientprotocol.v1.structures.RefuseMembershipRequest]
 * and then calling its `submit` function.
 */
@Serializable
@SerialName("refuse_membership")
internal data class RefuseMembership private constructor(
