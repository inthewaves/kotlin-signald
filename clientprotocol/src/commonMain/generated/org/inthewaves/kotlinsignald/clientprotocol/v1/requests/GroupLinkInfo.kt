 ...
 * an instance of [org.inthewaves.kotlinsignald.clientprotocol.v1.structures.GroupLinkInfoRequest] and
 * then calling its `submit` function.
 */
@Serializable
@SerialName("group_link_info")
internal data class GroupLinkInfo private constructor(
